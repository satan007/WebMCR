	...
	var messageBoxText = document.getElementById('comment-error-text')
			...
			if (req.readyState != 4 || 
             ...
             if ( response['code'] == 0 ) { document.location.reload(true); return false; }
				 ...
				 if (antibot != null ) {
				    antibot.value = ''
					document.getElementById('comment-captcha').src = '/instruments/captcha/captcha.php?refresh=' + rand(1337,31337) 			 
				 }
			 }
...
var img_src = '/instruments/captcha/captcha.php?refresh=' + rand(1337,31337)
if (img_obj == null ) {
...
function Restore() {
	...
	if  (req.readyState != 4 || 
		...
		(req.status == 0 && req.responseText.length == 0)) return false
		  ...
		  document.getElementById('antibot-visual').src = '/instruments/captcha/captcha.php?refresh=' + rand(1337,31337)
...
function LoadProfile(form,pid) {
	...
	var Ava = new Image()
	    Ava.src = '/skin.php?user_id='+pid+'&refresh='+rand(1337,31337)
	    Ava.onload = function () {
...
function UpdateProfile(admTrg) {
	...
	var event = function () {
	    ...
	    var Ava = new Image()
	        Ava.src = '/skin.php?user_id=' + response['id'] + '&refresh='+rand(1337,31337)
	        Ava.onload = function () {
		...
		if (admTrg == null) {
			...
			var Mini = new Image()
				Mini.src = '/skin.php?mini=' + response['id'] + '&refresh=' + rand(1337,31337)  
